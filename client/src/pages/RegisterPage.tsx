  ...
  return (
    <div className="min-h-screen bg-[#F0F4F9] flex items-center justify-center p-4 sm:p-6 lg:p-10 font-sans selection:bg-blue-500 selection:text-white">
      <div className="w-full max-w-[1060px] bg-white rounded-[32px] border border-slate-200/80 shadow-2xl overflow-hidden grid grid-cols-1 lg:grid-cols-12 min-h-[640px]">
        ...
        {/* Right Side: Clean White Registration Card (6 cols) */}
        <div className="lg:col-span-6 p-8 sm:p-12 flex flex-col justify-between bg-white">
          <div>
            ...
            <div className="text-center mb-5">
              ...
              <p className="text-xs sm:text-sm text-slate-500 mt-1">
                Enter your details to get started with DeliveryProof
              </p>
            </div>

            {/* Error Banner */}
            {error && (
              <div className="p-3.5 mb-4 rounded-xl bg-red-50 border border-red-200 flex items-start gap-2.5 text-xs text-red-700 animate-in fade-in">
              ...
              <div>
                ...
                <div className="relative rounded-xl border border-slate-200 bg-white focus-within:border-blue-600 focus-within:ring-3 focus-within:ring-blue-500/15 transition-all">
                  ...
                  <input
                    ...
                    className="w-full pl-10 pr-4 py-2 text-xs sm:text-sm text-slate-900 placeholder:text-slate-400 bg-transparent rounded-xl focus:outline-none"
                  />
                </div>
              </div>
              ...
              <div>
                ...
                <div className="relative rounded-xl border border-slate-200 bg-white focus-within:border-blue-600 focus-within:ring-3 focus-within:ring-blue-500/15 transition-all">
                  ...
                  <input
                    ...
                    className="w-full pl-10 pr-10 py-2 text-xs sm:text-sm text-slate-900 placeholder:text-slate-400 bg-transparent rounded-xl focus:outline-none"
                  />
                  {isEmailValid && (
              ...
              <div>
                ...
                <div className="relative rounded-xl border border-slate-200 bg-white focus-within:border-blue-600 focus-within:ring-3 focus-within:ring-blue-500/15 transition-all">
                  ...
                  <input
                    ...
                    className="w-full pl-10 pr-11 py-2 text-xs sm:text-sm text-slate-900 placeholder:text-slate-400 bg-transparent rounded-xl focus:outline-none"
                  />
                  <button
                    type="button"
            ...
            <button
              ...
              className="w-full py-2 px-4 bg-white hover:bg-slate-50 border border-slate-200 rounded-xl text-xs sm:text-sm font-semibold text-slate-700 transition-all flex items-center justify-center gap-2.5 cursor-pointer shadow-2xs hover:border-slate-300 active:scale-[0.99]"
            >
          ...
          {/* Bottom Sign In Link & Security Note */}
          <div className="pt-4 border-t border-slate-100 text-center text-xs text-slate-500 flex flex-col items-center gap-1.5">
            <div>
